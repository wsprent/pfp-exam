...
\begin{frame}[c]{Combining \texttt{EdgeSamples}}
  \begin{itemize}
  \item Perhaps too fine grained.
  \item Requires farther reaching changing.
  \end{itemize}
 \begin{figure}[H]
  \includegraphics[width=0.7\linewidth]{../threadscope/combinegrouped/bigflake}
  \includegraphics[width=0.3\linewidth]{../threadscope/combinegrouped/sparks}
...
\begin{frame}[c]{Filling \texttt{DrawOrders}}
  \begin{itemize}
  \item Most course granularity.
  \item Results in heavy GC.
  \end{itemize}
 \begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{../threadscope/fillorder/lines}\\
  \includegraphics[width=0.3\linewidth]{../threadscope/fillorder/lines-zoom}
  \includegraphics[width=0.4\linewidth]{../threadscope/fillorder/lines-spark}
