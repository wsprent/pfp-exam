...
\item \textbf{BigSquare:} Draws a big pink snowflake (named for legacy reasons). The purpose of this benchmark is to only have one call to the rasteriser containing many \texttt{Primitives}. See Figure \ref{fig:bigsquare-benchmark}.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.4\linewidth]{../bigsquare}
